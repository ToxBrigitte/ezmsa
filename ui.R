    ...
    mainPanel(
      ...
      tabsetPanel(
        ...
        tabPanel("Home",
                 ...
                 p(HTML(paste(
                   "Looking for the Excel version? Looking for a CSV input template?",
                   tags$a(href = " https://github.com/ToxBrigitte/ezmsa", 
                          target = "_blank",
                          em(
                 ...
                 h5(HTML(
                   paste0(
                     "***NOTE: Please note that measurements which are very large compared to concentrations, e.g. peak areas in the 10",
                     tags$sup("7") ,
                     " range, will create computational issues. The script will crash and you will get a Disconnected from server message. To avoid that, divide all peak areas by the mean or maximum order of magnitude for measurements before uploading the data set. The script will run, and the calculated concentration will be the correct one.***"
                   )
                 )), 
                 ...
                 h5(HTML(paste("Displays ", strong("graphical representations"), " of the data. The top graph, the ", strong("regular"), " standard addition
                               ...
                               strong("inverted"), " standard addition calibration curve, uses measurements on the x axis and concentration on the y axis. The 
                 ...
                 p(HTML(paste("Laboratoire de sciences judiciaires et de médecine légale",
                              ...
                              "Version 1.0.1, Copyright © 2026", sep="<br/>")),align = "center")
        ),
        
        #Displays the plot generated by the analyse
        tabPanel("Plots", plotlyOutput("stdPlot"), br(), plotlyOutput("invPlot"),
        ...
        tabPanel("Results", 
                 fluidRow(
                   ...
                   column(6, 
                          ...
                          HTML((paste0(p(strong("Calculated concentration: "), style="color:red"), span(textOutput("calcRes"), style="color:red")))),
        ...
        tabPanel("Report", 
                 ...
                 textInput("reportName", "Report title", value = ""),
        ...
        tabPanel("Contact", 
                 ...
                 h5("The EZMSA R application was conceptualized by Brigitte Desharnais and coded by Étienne Lebrun, 
                    based on work from the EZMSA team Jocelyn V. Abonamah, Brigitte Desharnais and Szabolcs Sofalvi."),
                 #br(),
                 #h2("Citation"),
